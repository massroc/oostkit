defmodule WorkgroupPulseWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller,
        formats: [:html, :json],
        layouts: [html: WorkgroupPulseWeb.Layouts]
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {WorkgroupPulseWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: WorkgroupPulseWeb.Router,
        statics: WorkgroupPulseWeb.static_paths()
    end
  end

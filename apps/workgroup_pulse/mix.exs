defmodule WorkgroupPulse.MixProject do
  use Mix.Project
  ...
  defp aliases do
    [
      ...
      "assets.build": ["tailwind workgroup_pulse", "esbuild workgroup_pulse"],
      "assets.deploy": [
        "tailwind workgroup_pulse --minify",
        "esbuild workgroup_pulse --minify",
        "phx.digest"
      ],

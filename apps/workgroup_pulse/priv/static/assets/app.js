...
`
  ...
  Hooks2.SheetCarousel = {
    ...
    _applyCoverflow() {
      ...
      const ROTATE_PER_SLIDE = 12;
      const MAX_ROTATE = 20;
      const SCALE_PER_SLIDE = 0.06;
      const MIN_SCALE = 0.8;
      ...
      slides.forEach((slide, index) => {
        ...
        slide.style.transform = `translateX(${tx}px) perspective(800px) rotateY(${rotateY}deg) scale(${scale})`;
